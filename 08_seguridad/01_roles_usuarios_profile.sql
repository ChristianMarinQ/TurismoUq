...
-- es quien es dueno de las tablas/vistas/paquetes).
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Perfil con limites de sesion, para los 4 usuarios de demostracion.
-- ---------------------------------------------------------------------
CREATE PROFILE perfil_operativo LIMIT
  SESSIONS_PER_USER      2      -- maximo 2 sesiones simultaneas por usuario
  IDLE_TIME              30     -- se desconecta tras 30 min sin actividad
  CONNECT_TIME           480    -- maximo 8 horas por conexion
  FAILED_LOGIN_ATTEMPTS  3      -- se bloquea tras 3 intentos fallidos
  PASSWORD_LOCK_TIME     1      -- 1 dia bloqueado tras exceder los intentos
  PASSWORD_LIFE_TIME     90;    -- la clave expira cada 90 dias

-- ---------------------------------------------------------------------
-- Un usuario de ejemplo por rol, para la demo de la sustentacion.
