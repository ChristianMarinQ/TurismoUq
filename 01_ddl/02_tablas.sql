...
-- Ver docs/00_modelo_ER.md para la justificacion de cada decision de diseno.
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- 5. TEMPORADA  (filas concretas por ano - ver decision de diseno 2)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 8. RESERVA  (tabla historica -> tablespace dedicado)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 9. RESERVA_HABITACION  (asociativa N:M - ver decision de diseno 1)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 13. RESENA  (= "RESENA" del enunciado, ver nota de nomenclatura en docs/00_modelo_ER.md)
-- ---------------------------------------------------------------------
CREATE TABLE resena (
...
-- ---------------------------------------------------------------------
-- Indices de apoyo a FKs muy consultadas (no son los de la Entrega 3,
-- esos se justifican con planes de ejecucion mas adelante)
-- ---------------------------------------------------------------------
