...
-- Tablespace dedicado al histórico de reservas (ver docs/00_modelo_ER.md, sección 5).
-- Aquí vivirán RESERVA, RESERVA_HABITACION, PAGO y RESERVA_SERVICIO.
...
-- reemplaza la línea DATAFILE por la ruta completa, por ejemplo en Windows:
--   DATAFILE 'C:\APP\ORACLE\ORADATA\XE\XEPDB1\ts_historico_reservas01.dbf'
-- (ajusta según donde haya quedado instalado tu Oracle XE 21c).

-- Usuario/esquema del proyecto. CAMBIA la clave antes de usarla en producción.
...
-- A partir de aquí, todos los demás scripts (02_tablas.sql en adelante)
